...
`LO` suffixes on field names such as 'HRHI' and 'HRLO' are optional (although recommended
...
ap3.scores$total <- rowSums(ap3.scores[,endsWith(colnames(ap3.scores), 'ap3score')], na.rm = TRUE)
ap3.scores
```
